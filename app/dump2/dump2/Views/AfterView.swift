          ...
          ForEach(vm.recordingsList, id: \.createdAt) { recording in
            VStack {
              ...
              .background(
                Color(
                  #colorLiteral(
                    red: 0.5568627715, green: 0.3529411852, blue: 0.9686274529, alpha: 1))
              )
              .cornerRadius(30)
              .shadow(
                color: Color(
...
struct AfterRecordView_Previews: PreviewProvider {
